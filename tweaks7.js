(function () {
  ...
  function createSettingsModal() {
    ...
    const styles = `
      ...
      /* Defines the container box for the Tweaks button in the sidebar */
      #workspace-tab-tweaks {
         justify-content: center !important;
         padding: 0 !important;
         width: 100% !important;
         min-height: 40px !important; /* Force standard height so it isn't squashed */
         margin-top: 2px !important;  /* Add vertical breathing room */
         margin-bottom: 2px !important;
      }
      /* Centers the internal span wrapper */
      ...
      /* FORCE SVG VISIBILITY & ALIGNMENT */
      #workspace-tab-tweaks svg {
         ...
         margin: 0 auto !important; /* Ensure the SVG itself is centered */
      }
    `;
