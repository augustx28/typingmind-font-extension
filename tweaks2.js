(function () {
  ...
  const settingsKeys = {
    ...
    // hideProfile: "tweak_hideProfile", // REMOVED
    // hideChatProfiles: "tweak_hideChatProfiles", // REMOVED
    ...
    // --- Global UI Font Key ---
    // Stores an object:
    // { name: string, weight: '100'...'900', isGoogle?: boolean, isUrl?: boolean, custom?: boolean, url?: string }
  ...
  function loadGlobalGoogleFont(fontName) {
    ...
    // UPDATED: Loading all weights from 100 to 900
  ...
  function applyStylesBasedOnSettings() {
    ...
    // Removed hideProfile variable
    // Removed hideChatProfiles variable
    ...
    // Removed Profile Button Logic
    
    // Removed Chat Profiles Logic
  ...
  function createSettingsModal() {
    ...
    // UPDATED: Removed Profile and Chat Profile options from this list
    ...
    // --- NEW: Global UI Font Section with URL support and expanded weights ---
