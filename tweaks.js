(function () {
  ...
  function loadGlobalGoogleFont(fontName) {
    ...
    // REVERTED TO TWEAKS 1 LOGIC (300-700 weights)
  ...
  function applyStylesBasedOnSettings() {
    ...
    // Removed hideProfile and hideChatProfiles logic here
  ...
  function createSettingsModal() {
    ...
    const styles = `
      ...
      /* --- WORKSPACE TWEAKS BUTTON ALIGNMENT FIX --- */
    ...
    // --- NEW: Global UI Font Section with URL support (REVERTED TO TWEAKS 1 HTML) ---
  ...
  // --- REVERTED TO TWEAKS 1 LOGIC (Removes explicit font-weight:400) ---
