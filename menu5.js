(() => {
  ...
  const css = String.raw`
    ...
    /* New Chat Button Background - ULTRA SPECIFIC FIX */
    /* Only targets the button if it is explicitly a button or link with cursor-pointer */
    .md\:pl-\[--workspace-width\] .flex-shrink-0 .bg-\[--workspace-color\] .justify-center.cursor-pointer > .overflow-hidden {
      background-color: ${BUTTON_BG} !important;
      transition: background-color 0.2s ease;
    }

    /* New Chat Button Hover Effect */
    .md\:pl-\[--workspace-width\] .flex-shrink-0 .bg-\[--workspace-color\] .justify-center.cursor-pointer > .overflow-hidden:hover {
