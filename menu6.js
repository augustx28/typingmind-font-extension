(() => {
  ...
  const css = String.raw`
    ...
    /* New Chat Button Background - STYLES ONLY THE HEADER BUTTON */
    /* Excludes any element inside a scrollable list or menu (like model dropdowns) */
    .md\:pl-\[--workspace-width\] .flex-shrink-0 .bg-\[--workspace-color\] .justify-center > .overflow-hidden:not([role="menu"] *):not([class*="overflow-y"] *) {
      background-color: ${BUTTON_BG} !important;
      transition: background-color 0.2s ease;
    }

    /* New Chat Button Hover Effect */
    .md\:pl-\[--workspace-width\] .flex-shrink-0 .bg-\[--workspace-color\] .justify-center > .overflow-hidden:not([role="menu"] *):not([class*="overflow-y"] *):hover {
