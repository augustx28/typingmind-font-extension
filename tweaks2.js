(function () {
  ...
  const observer = new MutationObserver(() => {
    ...
    if (workspaceBar) {
      ...
      // If we can't find settings button, try to fall back to other buttons to get the class name
      ...
      if (!tweaksButton && settingsButton && referenceButtonForStyle) {
        ...
        // Copy the reference classes exactly. This should include flex-col, gap-1.5, etc.
        ...
        // Create SVG Icon directly (no extra wrapper div)
        const svgIcon = document.createElementNS("http://www.w3.org/2000/svg", "svg");
        // Use w-4 h-4 to match the provided Settings button reference
        ...
        // Create Text Span directly (no outer span wrapper)
        // Use the exact classes provided in the user's HTML snippet
        ...
        // Append directly to button to respect flex-col and gap-1.5 from reference classes
