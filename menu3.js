(() => {
  const STYLE_ID = 'tm-custom-tweaks-v3';
  
  // Variables
  const BACKGROUND = '#191919';
  const ICON = '#DA9010';
  const BUTTON_BG = '#38383c';
  const HOVER_BG = '#4E4E52'; // Lighter grey for hover effect
  ...
  const css = String.raw`
    ...
    /* Overflow hidden background (New Chat Button) */
  ...
  console.log('[TypingMind] Custom CSS V3 (Hover Fixed) injected.');
})();
