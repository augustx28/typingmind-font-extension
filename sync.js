...
async download(key, isMetadata = false) {
  ...
  class CloudSyncApp {
    ...
    insertSyncButton() {
      ...
      // Inject styles for the status dot if not present
      ...
      // CLASSES EXPLANATION:
      // 1. Layout: Copied from your "Expanded/Wider" settings button example (inline-flex, flex-col, etc.)
      // 2. Colors: Added 'text-slate-900/70' for Light Mode and 'dark:text-white/70' for Dark Mode.
      ...
      // INNER HTML:
      // 1. Icon Container with relative positioning for the dot.
      // 2. SVG Icon (18px).
      // 3. Text Span ("Sync") using the exact classes from your Settings example.
      button.innerHTML = `
