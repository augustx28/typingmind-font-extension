(function () {
  ...
  const settingsKeys = {
    ...
    hideProfile: "tweak_hideProfile", // Restored from Tweaks 1
    hideChatProfiles: "tweak_hideChatProfiles", // Restored from Tweaks 1
    ...
    // --- Global UI Font Key ---
    // Stores an object: { name, weight, isGoogle, isUrl, custom, url }
  ...
  function loadGlobalGoogleFont(fontName) {
    ...
    // Updated to include full range of weights for fonts like Inter
  ...
  function applyStylesBasedOnSettings() {
    ...
    const hideProfile = getSetting(settingsKeys.hideProfile); // Restored
    const hideChatProfiles = getSetting(settingsKeys.hideChatProfiles); // Restored
  ...
  function createSettingsModal() {
    ...
    const checkboxSettings = [
      ...
      { key: settingsKeys.hideProfile, label: "Hide 'Profile' button" }, // Restored
      { key: settingsKeys.hideChatProfiles, label: "Hide 'Chat Profiles' button" }, // Restored
    ...
    customFontFamilyInput.querySelector('input').style.width = '120px'; // Shortened
    ...
    fontSizeInput.querySelector('input').style.width = '80px'; // Shortened
    ...
    faviconFileInputEl.style.width = '140px'; // Shortened
  ...
  function applyCustomFont() {
    ...
    // Force default weight in chat to prevent global weight from cascading
    styleDeclarations.push(`  font-weight: 400 !important;`);
