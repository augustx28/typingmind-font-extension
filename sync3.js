    insertSyncButton() {
      ...
      // Updated classes to exactly match the flex/layout properties of the Settings button
      // Preserved original color classes to ensure it works in both Light and Dark mode
      ...
      // Updated InnerHTML:
      // 1. Wrapper div now has explicit w-[18px] h-[18px] to match Settings icon size
      // 2. SVG matches 18px size
      // 3. Span uses font-semibold to match Settings text weight
      button.innerHTML = `
        ...
        <span class="font-semibold mx-auto self-stretch text-center text-xs leading-4 md:leading-none w-full md:w-[51px]" style="hyphens: auto; word-break: break-word;">Sync</span>
      `;
