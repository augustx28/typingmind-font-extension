/**
 * Text Highlighter Extension for TypingMind - v1.2 FINAL
 *
 ...
 *
 * Key Updates:
 * - FIX: Highlight color is now visible. Added '!important' to CSS to override app styles.
 * - Highlight color is orange.
 * - Mobile-friendly: Use touch to select text and create highlights.
 * - Simple Deletion: Tap or click a highlight to get the remove option.
 * - Performance: Efficient logic for applying highlights.
 * - Accuracy: Correctly highlights only the selected text.
 */
...
(() => {
  ...
  class TextHighlighter {
    constructor() {
      ...
      // --- CONFIGURATION ---
      this.HIGHLIGHT_COLOR = '#FFC069'; // Orange highlight color
    ...
    highlightSelection() {
      ...
      try {
        ...
        // **VISIBILITY FIX**: Use setProperty with '!important' to override app styles.
        span.style.setProperty('background-color', this.HIGHLIGHT_COLOR, 'important');
    ...
    init() {
      ...
      console.log("Text Highlighter extension loaded successfully. 🍊 (v1.2)");
    }
  }
