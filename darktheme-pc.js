(() => {
  ...
  // Combined color tweaks for both dark and light modes
  const css = `
    ...
    /* 9) NEW: .md:pl-[--current-sidebar-width] .overflow-y-auto .@container */
    ...
    /* 10) MERGED: Dark Mode Chat Box Area */
    ...
    /* 11) MERGED: Light Mode Chat Box Area */
    html:not(.dark) .\\@container .items-start .overflow-auto,
    body:not(.dark) .\\@container .items-start .overflow-auto {
  ...
  function init() {
    ...
    // If your app toggles dark mode via class or data-theme, keep CSS active
