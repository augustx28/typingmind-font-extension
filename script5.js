/*  TypingMind Custom-Font Extension
    Douglas Crockford (impersonated 😉) – v1.2.0 | Shift+Alt+F opens the panel
...
#chat-container, #chat-container * {
  ...
  function addMenuButton() {
    ...
    // FIXED: Filter out any icon utility classes that would override our SVG
    const baseClasses = [...settingsButton.classList]
      .filter(c => !c.startsWith("i-")) // Remove any icon utility classes
      .join(" ");
    ...
    // Match TypingMind's sidebar button structure
