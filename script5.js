(function () {
  ...
  /* The remainder of script4.js (saveSetting, toggleModal, observers,
     custom font, favicon handling, etc.) is exactly as in the original
     file you supplied. No logic has been altered other than the
     insertions marked ➊ – ➐. */

  /* *** Original bottom-half of the file remains here (omitted for brevity) *** */
})();
sc
