(function() {
    ...
    const customCSS = `
        ...
        .h-\\[var\\(--workspace-height\\)\\] .sm\\:block .md\\:flex-col{
         border-width:0px; /* <-- MODIFIED */
         border-color:#474747;
         border-top-left-radius:9px;
         border-top-right-radius:9px;
         border-bottom-left-radius:9px;
         border-bottom-right-radius:9px;
         background-color:rgba(76,76,76,0); /* <-- MODIFIED */
         height:797px;
         position:relative;
         top:9px;
        ...
        /* Full -- MODIFIED */
        .bg-\\[--workspace-color\\] > .flex > .w-full{
         border-top-left-radius:12px; /* <-- MODIFIED */
         border-top-right-radius:12px; /* <-- MODIFIED */
         border-bottom-left-radius:12px; /* <-- MODIFIED */
         border-bottom-right-radius:12px; /* <-- MODIFIED */
         width:232px;
         color:#db801d;
        }
