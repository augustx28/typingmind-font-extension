(() => {
  const STYLE_ID = 'tm-custom-tweaks-v5';
  ...
  const css = String.raw`
    ...
    /* New Chat Button Background - FIXED to exclude images (thumbnails) */
    .md\:pl-\[--workspace-width\] .flex-shrink-0 .bg-\[--workspace-color\] .justify-center > .overflow-hidden:not(:has(img)) {
      background-color: ${BUTTON_BG} !important;
      transition: background-color 0.2s ease;
    }

    /* New Chat Button Hover Effect - FIXED to exclude images (thumbnails) */
    .md\:pl-\[--workspace-width\] .flex-shrink-0 .bg-\[--workspace-color\] .justify-center > .overflow-hidden:not(:has(img)):hover {
      background-color: ${HOVER_BG} !important;
      cursor: pointer;
    }

    /* =========================================
       PART 3: UI CLEANUP (Hidden Elements & Adjustments)
       ========================================= */
    ...
    /* =========================================
       PART 4: PADDING ADJUSTMENTS
       ========================================= */

    /* Justify center padding (General) */
    .md\:flex .antialiased .justify-center {
      padding-top: 5px;
    }

    /* Justify center padding (Sidebar context) */
    ...
    /* Division Visibility Fix (Replaces Transform Fix) */
    #nav-handler .h-\[--workspace-height\] .md\:w-auto {
      visibility: hidden !important;
    }

    /* Object contain (Added !important) */
    .max-h-full div .object-contain {
  ...
  console.log('[TypingMind] Custom CSS V5 (Complete) injected.');
})();
