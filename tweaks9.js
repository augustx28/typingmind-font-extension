(function () {
  ...
  const settingsKeys = {
    // --- Existing Tweak Keys (FROM TWEAKS 2 - No Profile/ChatProfile keys) ---
  ...
  // --- RESTORED FROM TWEAKS 1 (Standard weights 300-700) ---
  ...
  // --- KEPT FROM TWEAKS 2 (Removes profile hiding logic) ---
  function applyStylesBasedOnSettings() {
    ...
    // Removed hideProfile and hideChatProfiles logic here (TWEAKS 2)
  ...
  function createSettingsModal() {
    ...
    // --- KEPT FROM TWEAKS 2 (No Profile/ChatProfile checkboxes) ---
    ...
    // --- RESTORED FROM TWEAKS 1 (Standard Font Weights 300-700) ---
  ...
  // --- RESTORED FROM TWEAKS 1 (No Forced Weight) ---
