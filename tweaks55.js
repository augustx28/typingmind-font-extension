(function () {
  ...
  function createSettingsModal() {
    ...
    const styles = `
      ...
      /* Container: Fix Spacing and Alignment */
      #workspace-tab-tweaks {
         justify-content: center !important;
         padding-left: 0 !important;
         padding-right: 0 !important;
         /* RESET MARGINS: Let the native flex-gap handle spacing */
         margin: 0 !important; 
         width: 100% !important;
         /* PREVENT SQUASHING: Force standard button height */
      ...
      /* FORCE SVG VISIBILITY: Ensures icon is never 'invincible' */
